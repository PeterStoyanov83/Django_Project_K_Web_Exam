...
from .forms import CustomUserCreationForm, CustomAuthenticationForm, LaptopForm, ClientForm, CustomUserForm, ClientFileForm
...
def profile(request):
    try:
        ...
        # If the user doesn't have a client profile, create one
...
def profile_edit(request):
    ...
    return render(request, '../client_management/templates/client_management/profile_edit.html', {
        'user_form': user_form,
...
def apply_for_course(request):
    ...
    return render(request, '../client_management/templates/client_management/apply_for_course.html', {'courses': courses})
